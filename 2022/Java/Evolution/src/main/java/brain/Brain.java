...
public class Brain {
    ...
    private ArrayList<InnerNode> innerNodes = new ArrayList<>();
    private ArrayList<OutputNode> outputNodes = new ArrayList<>();

    private Map<Object, InputNode> inputNodesMap = new HashMap<>();
    private Map<Object, InnerNode> innerNodesMap = new HashMap<>();
    private Map<Object, OutputNode> outputNodesMap = new HashMap<>();
